    const excursiones = [
        ...
        },
        {
            ...
            img: "./assets/purmamarca.jpg",
            cantidadPersonas: 1
        },
        {
            id: 3,
            destino: "Tour a Bariloche",
            descripcion: "Descubre el corazón de la Patagonia argentina, un destino que combina paisajes de ensueño, aventuras emocionantes y una rica cultura local. Situada a orillas del majestuoso Lago Nahuel Huapi y rodeada por los imponentes Andes, es el lugar perfecto para los amantes de la naturaleza y las actividades al aire libre. Bariloche te recibe con sus paisajes de postal, donde los picos nevados de las montañas se reflejan en las aguas cristalinas del lago.",
            precioPorPersona: 60000,
            img: "./assets/bariloche.jpg",
            cantidadPersonas: 1
        },
        {
            id: 4,
            destino: "Valle de la luna",
            descripcion: "Descubre el misterioso y fascinante Valle de la Luna, ubicado en el Parque Provincial Ischigualasto en la provincia de San Juan. Este paisaje surrealista, con formaciones rocosas únicas y una geología impresionante, te transportará a otra época. Explora este desierto lunar, declarado Patrimonio de la Humanidad por la UNESCO, donde los colores y las formas de las rocas cuentan la historia de millones de años.",
            precioPorPersona: 62000,
        img: "./assets/valleLuna.webp",
        cantidadPersonas: 1
    },
        {
            id: 5,
    ...
    precioPorPersona: 69000,
    img: "assets/glaciarPeritoMoreno.jpg",
    cantidadPersonas: 1
},
    {
        id: 7,
